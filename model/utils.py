...
def preprocess_image(image,out_size,gt_bboxes=None):
    ih, iw    = out_size
    h,  w, _  = image.shape
...
def postprocess_bboxes(pred_bboxes,orig_img_shape,input_size,score_threshold):
...
def draw_bboxes(image, bboxes, classes, show_label=True):
    """
